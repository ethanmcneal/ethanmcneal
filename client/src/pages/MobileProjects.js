...
const MobileProjects = () => {
    return(
        <div className='projects-container' >
            <div className='mobile-project-container' style={{backgroundColor: 'rgb(25 53 81)', minWidth: window.innerWidth}}>
            ...
            <div className='mobile-project-container' style={{backgroundColor: 'rgb(34,34,34)', minWidth: window.innerWidth}}>
