    ...
    return(
        <div>
            <div style={{display: 'flex', justifyContent: 'center'}}>
                <img src={hawaii} alt='zipline.png' style={{width: '500px', height: '300px', margin: '3em'}}/>
                    <div style={{margin: '0 3em 3em 0', fontSize: '22px', textAlign: 'center'}}>
            ...
            <div style={{display: 'flex', justifyContent: 'center'}}>
                <div style={{margin: '0 0 3em 3em', fontSize: '22px', textAlign: 'center'}}>
                ...
                <img src={kayak} alt='kayak.png' style={{width: '500px', height: '300px', margin: '0 3em'}}/>  
            </div>
        </div>
    )
}
