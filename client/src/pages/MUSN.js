...
const MUSN = () => {
    return(
        ...
        <div className='info-card2' style={{marginBottom: '6em'}}>
            Me and one of my group members decided to work on this project after our cohort, to clean it up a bit and make it smoother around the edges, you can check out how the project was at the end of the 6 hours alloted for this hackathon, or take a look at our work in progress at the forked github.
        </div>
        </div>
