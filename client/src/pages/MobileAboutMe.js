...
const MobileAboutMe = () => {
    return(
        <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
            ...
            <div className='mobile-project-container' style={{ backgroundColor: '#3C4650', color: 'white', width: window.innerWidth}}>
            ...
            <div className='mobile-project-container' style={{ backgroundColor: '#EF4941', color: 'white', width: window.innerWidth}}>
            <h1 style={{margin: '0'}}>Hobbies</h1>
            <img src={hawaii} alt='zipline.png' style={{width: window.innerWidth}}/>
            <p>I was raised in the outdoors, my first memories are of me with a fishing rod in my hand, I love the rocky mountain region, Montana and Utah in particular, other than that I play guitar and in my free time I play PC games. </p>                
            </div>
        </div>
    )
}
